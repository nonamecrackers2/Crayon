...
/**
 * This interface is what allows the {@link PhysicsThread} to retrieve a list of
 * {@link Level} objects without knowing where they come from. In this way, it
 * can be used for client Levels or server Levels and, in the case of immersive
 * portals, it can be used to provide multiple client Levels.
 * 
 * @see PhysicsThread
